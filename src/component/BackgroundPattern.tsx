	...
	return (
		<div className="fixed inset-0 z-0 overflow-hidden pointer-events-none" data-testid="background-pattern">
			...
			<div className="absolute inset-0 opacity-50 flex items-center justify-center">
				<div className="absolute top-20 -left-2 md:left-0 lg:left-20 text-blue-400 transform rotate-12 opacity-60 delay-1000" data-testid="icon">
					<Globe size={48} />
				</div>
				<div className="absolute bottom-20 -left-5 md:left-0 lg:left-20 text-blue-400 transform rotate-12 opacity-60 delay-1000" data-testid="icon">
					<MapPin size={48} />
				</div>
				<div className="absolute bottom-32 -right-4 md:-right-5 lg:right-20 text-purple-400 transform -rotate-6 opacity-60 delay-2000" data-testid="icon">
					<Search size={48} />
				</div>
				<div className="absolute top-40 -right-2 md:-right-2 lg:right-10 text-indigo-400 transform rotate-3 opacity-60 delay-3000" data-testid="icon">
					<Globe size={48} />
				</div>
			</div>
		</div>
